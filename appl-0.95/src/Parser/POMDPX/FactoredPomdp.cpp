...
unsigned int FactoredPomdp::start() {
	...
	cerr << "Functions: "<< stateFunctionList.size() << "  States: " << stateList.size() << "\nThe number of states do not correspond to the number of state transition functions" << endl;
	exit(XML_INPUT_ERROR);
    }
